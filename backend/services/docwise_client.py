...
DOCWISE_DAILY_PROMPT = (
    ...
    "It is typically a SHORT number (5-6 digits, e.g. 172865). "
    "DELIVERY NOTE NUMBER = the large bold number in the document TITLE HEADER BOX, "
    "immediately next to the text '納品書兼請求書'. It is typically a LONG number (10 digits, e.g. 8039444166). "
